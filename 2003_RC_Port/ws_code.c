...
void pump_control(MotorValsType *motor_vals)
{
  ...
  if (Digital_in_pressure == 0)
  {
    motor_vals->pump = RELAY_FWD;
  }
  else
  {
    motor_vals->pump = RELAY_OFF;
  }
...
* RETURNS:       
*******************************************************************************/
void foot_control(MotorValsType *motor_vals)
{
...
void  drive_stick_input(MotorValsType *motor_vals)
{
  ...
  if (((Oi_crab_x > (127 - CRAB_MODE_DEADZONE)) &&
       ...
       (Oi_crab_y < (127 + CRAB_MODE_DEADZONE))) ||
      ((Oi_crab_x > (CRAB_STICK_MAX_VALUE - CRAB_MODE_DEADZONE)) &&
       (Oi_crab_y > (127 - CRAB_MODE_DEADZONE))) ||
      ((Oi_crab_x < (CRAB_STICK_MIN_VALUE + CRAB_MODE_DEADZONE)) &&
       (Oi_crab_y > (127 - CRAB_MODE_DEADZONE))))
  {
    /* tank steer mode */
    ...
    else if (Oi_crab_x > (CRAB_STICK_MAX_VALUE - CRAB_MODE_DEADZONE))
    {
  ...
  {
    /* crab steer mode */
    motor_vals->lf_wheel = Oi_drive_y;
    motor_vals->rf_wheel = Oi_drive_y;
    motor_vals->lb_wheel = Oi_drive_y;
    motor_vals->rb_wheel = Oi_drive_y;
  }
...
{
  static unsigned char prev_loop_crab_pos = TWO_AXIS_CENTER;

  /* determine if the crab stick is in 1 or 2 axis mode */
  if (Oi_crab_y >= ONE_TWO_AXIS_CRAB_DIVIDER)
  {
    /* printf("one axis  "); */
    one_axis_crab_steering(crab_targets);
    prev_loop_crab_pos = TWO_AXIS_CENTER;
  }
  else
  {
    /* printf("two axis  "); */
    two_axis_crab_steering(crab_targets, &prev_loop_crab_pos);
  }

  /*
  printf(" Lcrab tar %d ", (int)crab_targets->left_crab_tar);
  */
...
*******************************************************************************/
void one_axis_crab_steering(CrabTargetsType *crab_targets)
{
  ...
  else
  {
    if (Oi_crab_x > (127 + ONE_AXIS_DEADZONE))
    {
      ...
      crab_targets->right_crab_tar = 127 + ((Oi_crab_x - 127) / 2);
    ...
    else if (Oi_crab_x < (127 - ONE_AXIS_DEADZONE))
    {
      /* turn wheels right */
      /* scale so we turn 180 degrees to 90 degrees */
      crab_targets->right_crab_tar = 127 - ((127 - Oi_crab_x) / 2);
      crab_targets->left_crab_tar = crab_targets->right_crab_tar;
    }
  }
...
* DOL:
*******************************************************************************/
void two_axis_crab_steering(CrabTargetsType *crab_targets,
                            unsigned char *prev_loop_crab_pos)
{
  UINT16 tmp;

  static unsigned char prev_loop_dir = TWO_AXIS_RIGHT;

  if ((Oi_crab_x > 127 - TWO_AXIS_DEADZONE) &&
      (Oi_crab_x < 127 + TWO_AXIS_DEADZONE) &&
      (Oi_crab_y > 127 - TWO_AXIS_DEADZONE) &&
      (Oi_crab_y < 127 + TWO_AXIS_DEADZONE))
  {
    crab_targets->left_crab_tar = 127;
  }
  else
  {
    ...
    if (Oi_crab_x < 127)
    {
      ...
      {
        /* Quadrant 1 */
        crab_targets->left_crab_tar = 63 + arctan(Oi_crab_y - 127,
                                                  127 - Oi_crab_x);
      }
      else
      {
        /* Quadrant 4 */
        crab_targets->left_crab_tar = arctan(127 - Oi_crab_x,
                                             127 - Oi_crab_y);
      }
    }
    else
    {
      ...
      {
        /* Quadrant 2 */
        crab_targets->left_crab_tar = 127 + arctan(Oi_crab_x - 127,
                                                   Oi_crab_y - 127);
      }
      else
      {
        /* Quadrant 3 */
        tmp = 191+ arctan(127 - Oi_crab_y, Oi_crab_x - 127);
  ...
  {
    *prev_loop_crab_pos = TWO_AXIS_NOT_CENTER;
    prev_loop_dir = TWO_AXIS_LEFT;
  }
  else if (crab_targets->left_crab_tar < STICK_RIGHT_SIDE)
  {
    *prev_loop_crab_pos = TWO_AXIS_NOT_CENTER;
    prev_loop_dir = TWO_AXIS_RIGHT;
  }
...
void crab_system(CrabTargetsType *crab_targets, MotorValsType *motor_vals)
{
  ...
  /*
  printf(" crabTar BRAD R %d L %d", (int)crab_targets->left_crab_tar,
  ...
  */
  ...
  /*
  printf(" crabTar POT  R %d L %d", (int)crab_targets->left_crab_tar,
         (int)crab_targets->right_crab_tar);
  printf("\n");
  */
  ...
  motor_vals->left_crab =
    crab_feedback_left(GET_ANALOG_VALUE_SHIFT(Analog_in_left_pot),
                       crab_targets->left_crab_tar);
  motor_vals->right_crab =
    crab_feedback_right(GET_ANALOG_VALUE_SHIFT(Analog_in_right_pot),
